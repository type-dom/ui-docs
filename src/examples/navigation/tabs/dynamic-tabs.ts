...
import { ITabPaneName, TdTabPane, TdTabs } from '@type-dom/ui';

export class TabsDynamicTabsExample extends TypeDiv {
  className = 'TabsDynamicTabsExample';
  tabIndex: number;
  ...
  handleTabsEdit = (
    targetName: ITabPaneName | undefined,
    action: 'remove' | 'add'
  ) => {
